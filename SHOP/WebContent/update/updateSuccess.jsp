	...
	<nav class="navbar navbar-expand-lg navbar-dark"
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			...
			<ul class="navbar-nav mb-2 mb-lg-0">
				<li class="nav-item me-2"><a class="btn btn-primary"
					href="<%=request.getContextPath()%>/login/login.jsp" role="button">로그인</a></li>
				<li class="nav-item me-2"><a class="btn btn-success"
					href="<%=request.getContextPath()%>/join/join.jsp" role="button">회원가입</a></li>
			</ul>
			<% } else { %>
			<ul class="navbar-nav mb-2 mb-lg-0">
				<li class="nav-item dropdown"><a
					...
					<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
						<li><a class="dropdown-item"
							href="<%=request.getContextPath()%>/logout.jsp">로그아웃</a></li>
				...
				<div class="bg-light p-5 mt-5">
					<form method="post">
						...
						<input class="form-control mb-3" name="userID"
							...
							<a class="btn btn-outline-success me-2" href="<%=request.getContextPath()%>/main.jsp" role="button"> 확인</a>
